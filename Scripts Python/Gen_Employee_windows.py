...
def generate_employe(size_serv, name_serv, working_h, third):      

        with open("employe_win.txt", "a") as fich: 
                employes = names(size_serv)
                for name in employes:
                        i = int(random.uniform(0,3))
                        fich.write(name + '|' + random_patronyme() + '|' + name_serv + '|' + random_ip(third) + '|' + working_h[i] + '\n')
...
def main():                                                                           
    ...
    for i in range(0,5):
        ...
        generate_employe(size_service, name_service[i], working_hours, thirds[i])                 
